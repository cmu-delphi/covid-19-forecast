...
* On each forecast date, we look at the most recent `r as.numeric(forecast_dates[1] - start_day_zebra(forecast_dates[1]))` and keep the top 200 counties by total cases
over the period.

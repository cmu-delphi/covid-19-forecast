...
### This is no different from the single signal version!!

The reason is that the only signal `zyzzyva` uses that requires corrections is the response `usa-facts_confirmed_incidence_num`.
